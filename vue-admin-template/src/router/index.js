...
export const constantRoutes = [
  ...
  },
  {
    ...
    name: 'Tables',
    meta: { title: 'Tables', icon: 'el-icon-s-help' },
    children: [
      {
        path: 'categories',
        name: 'Category',
        component: () => import('@/views/table/categories'),
      ...
      },
      {
        path: 'replacewords',
        name: 'ReplaceWords',
        component: () => import('@/views/table/wordreplaces'),
        meta: { title: 'Replace Words', icon: 'table' }
      },
      {
        path: 'tele-account',
        name: 'TeleAccount',
